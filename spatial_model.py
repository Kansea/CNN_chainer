...
This program is used to train Spatial stream model.
"""
...
if __name__ == '__main__':
    ...
    print('===== << Start training spatial_model... >> =====')
    ...
    # 3. Load dataset.
    train, test = read_data.spatial_dataset()
    ...
    # 6. Setup trainer
    trainer = training.Trainer(updater, (20, 'epoch'), out='spatial_result')
